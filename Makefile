# 链接生成可执行文件
minimake: minimake.o preprocessing.o level2.o level3.o
	gcc -Wall -g minimake.o preprocessing.o level2.o level3.o -o minimake

# 编译主文件
minimake.o: minimake.c preprocessing.h level2.h level3.h
...
level3.o: level3.c level3.h level2.h
